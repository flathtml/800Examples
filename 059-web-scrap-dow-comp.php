...
<div class="row">
	...
	<div  align="center" class="col-md-6 shadow p-4 mb-4 border border-primary" style="background-color:pink">
		<h2>Get the Stock prices of Dow components by scraping the Input file</h2>
		<a href="https://money.cnn.com/data/dow30/"target=_blank">Input File : https://money.cnn.com/data/dow30/</a> &nbsp;&nbsp;
		 
</div>
	<div class="col-md-3">&nbsp; </div>      
</div>  
<?php
$html=file_get_contents("https://money.cnn.com/data/dow30/");
$the_start = explode('<li class="last-child"><a href="/video/markets/">Video</a></li>',$html);
$the_end = explode('<div class="clearfix"><div class="wsod_fRight wsod_disclaimer">',$the_start[1]);
echo $the_end[0];
 
?>
<h6><i>End of Data</i></h6>
</body>
</html>
