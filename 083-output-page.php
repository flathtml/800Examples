...
<div class="row">
	...
	<h6><i>File Loaded to table</i></h6>Following is the table data
     <p>
	 <form action="083-load-file-to-table.php">
 
     <input type="submit" value="click here"> to load the file into table again.
     </form> 
...
if ($result->num_rows > 0) {
	...
	echo "<table class='w3-table w3-striped w3-bordered'><tr class='w3-orange'><th>F-NAME</th><th>L-NAME</th></tr>";
