...
<div class="row">
	...
	<div  align="center" class="col-md-6 shadow p-4 mb-4 border border-primary" style="background-color:pink">
		<h2>Read an Input XML file that has 2 records,delete the second record</h2>
		<a href="055-books-copy.xml"target=_blank">Original File : 055-books-copy.xml (has 2 records)</a> &nbsp;&nbsp;
		<a href="055-books.xml"target=_blank">Output File : 055-books.xml (has 1 record)</a>
</div>
	<div class="col-md-3">&nbsp; </div>      
</div>  
<?php
...
$file = '055-books-copy.xml';
$newfile = '055-books.xml';

if (!copy($file, $newfile)) {
    echo "failed to copy $file...\n";
}
 
	$xml13=simplexml_load_file("055-books.xml");
	function delete_book_id($id, $filename = '055-books.xml')
	{
