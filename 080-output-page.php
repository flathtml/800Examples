...
<div class="row">
	...
	<h6><i>Record inserted in inventory table. Following is the latest copy of the table</i></h6>
    <a href="080-php-mysql-insert-form.php">Click here</a> to insert another record.		
</div>
	<div class="col-md-3">&nbsp; </div>      
</div>     
