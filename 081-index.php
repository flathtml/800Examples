        ...
        success:function(msg){
			...
			if(msg == msgcheck){
                ...
                $('.formData').slideUp();
                 ...
                 alert(msg + 'Some problem occurred, please try again.');
            }
        }
    });
}
...
<div class="container">
    <div class="row">
        <div class="panel panel-default users-content">
            <div class="panel-heading"><a href="index.html">Home</a>&nbsp;>&nbsp;Users Table Utility - <i>Add / Update / Delete records</i><a href="javascript:void(0);" class="glyphicon glyphicon-plus" id="addLink" onclick="javascript:$('#addForm').slideToggle();">Add</a></div>
